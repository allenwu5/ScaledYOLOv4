...
ort_session = onnxruntime.InferenceSession("yolov4_csp.onnx", so)
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply NMS
        pred = non_max_suppression(ort_outs, opt.conf_thres, opt.iou_thres, classes=opt.classes, agnostic=opt.agnostic_nms)
