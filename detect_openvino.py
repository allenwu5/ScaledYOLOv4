...
# Follow open_model_zoo\demos\python_demos\multi_camera_multi_target_tracking\multi_camera_multi_target_tracking.py
...
def detect(save_img=False):
    ...
    model_output_layer = "output"
    object_detector = Detector(ie_core, "yolov4_csp.xml", model_output_layer)
    ...
    for path, img, im0s, vid_cap in dataset:
        img = np.true_divide(img, 255.0).astype(np.float32)
        ...
        pred = object_detector.get_detections(img, detect_index)
        # (1, 15120, 85)
